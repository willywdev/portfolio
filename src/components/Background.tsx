export default function DotBackgroundDemo() {
	return (
		<div className="pointer-events-none top-0 left-0 h-screen w-screen dark:bg-black bg-white  dark:bg-grid-small-white/[0.2] bg-grid-small-black/[0.2] fixed inset-0 z-[-1]">
